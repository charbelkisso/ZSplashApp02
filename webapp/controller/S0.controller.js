...
], function (BaseController, MessageBox, D1_1464080436618, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.createSalesOrder.controller.S0", {
		...
		_onButtonPress: function () {
			...
			var sDialogName = "D1_1464080436618";
			this.mDialogs = this.mDialogs || {};
			var oDialog = this.mDialogs[sDialogName];

			if (!oDialog) {
				oDialog = new D1_1464080436618(this.getView());
		...
		onExit: function () {
			...
			var aControls = [{
				"controlId": "sap_Responsive_Page_0-content-sap_m_ObjectList-1527617691789",
				"groups": ["items"]
			}];
